...
jct15 = networld.junctionDef(x=24, y=24, cap=8, canStop=True, fareProb=fareProbMagnet, maxTraffic=16, src=trafficSrcHub,
                             sink=trafficSinkMajor)
...
jct20 = networld.junctionDef(x=24, y=35, cap=4, canStop=True, fareProb=fareProbPopular, maxTraffic=12,
                             src=trafficSrcMajor, sink=trafficSinkDrain)
...
junctions = [jct0, jct1, jct2, jct3, jct4, jct5, jct6, jct7, jct8, jct9, jct10, jct11, jct12, jct13, jct14, jct15,
             jct16, jct17, jct18, jct19, jct20, jct21, jct22, jct23, jct24, jct25, jct26, jct27, jct28, jct29, jct30,
             jct31]
...
streets = [strt0, strt1, strt2, strt3, strt4, strt5, strt6, strt7, strt8, strt9, strt10, strt11, strt12, strt13, strt14,
           strt15,
           strt16, strt17, strt18, strt19, strt20, strt21, strt22, strt23, strt24, strt25, strt26, strt27, strt28,
           strt29, strt30, strt31,
           strt32, strt33, strt34, strt35, strt36, strt37, strt38, strt39, strt40, strt41, strt42, strt43, strt44,
           strt45, strt46, strt47]
...
def runRoboUber(worldX, worldY, runTime, stop, junctions=None, streets=None, interpolate=False, outputValues=None,
    ...
    svcArea = networld.NetWorld(x=worldX, y=worldY, runtime=runTime, fareprob=args['fareProbNormal'],
                                jctNodes=junctions, edges=streets, interpolateNodes=interpolate)
    print("Exporting map...")
    ...
    while threadTime < threadRunTime:
        ...
        if stop.is_set():
            ...
            # print("Times: {0}, Fares: {1}, Taxis: {2}".format(outputValues['time'], outputValues['fares'].keys(),
            # outputValues['taxis'].keys()))
...
displaySurface = pygame.display.set_mode(size=displaySize,
                                         flags=pygame.RESIZABLE)  # |pygame.SCALED arrgh...new in pygame 2.0, but pip
# install installs 1.9.6 on Ubuntu 16.04 LTS
backgroundRect = None
